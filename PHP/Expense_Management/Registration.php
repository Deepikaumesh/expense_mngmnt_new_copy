...
$findexist="select * from user_registraion where username='".$username."'";
    ...
    $sql = "INSERT INTO user_registraion (username,email,phone,password) VALUES ('".$username."','".$email."','".$phone."','".$password."')";
