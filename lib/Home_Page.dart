          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: index == 4 ? Colors.deepPurple : Colors.grey.shade300,
              ),
              alignment: Alignment.center,
              child: Text(
                months[now.month - 3],
                style: TextStyle(
                  ...
                  color: index == 4 ? Colors.white : Colors.deepPurple,
                ),
              ),
            ),
          ),
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: index == 2 ? Colors.deepPurple : Colors.grey.shade300,
              ),
              alignment: Alignment.center,
              child: Text(
                months[now.month - 2],
                style: TextStyle(
                  fontSize: 20.0,
                  fontWeight: FontWeight.w600,
                  color: index == 2 ? Colors.white : Colors.deepPurple,
                ),
              ),
            ),
          ),
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: index == 1 ? Colors.deepPurple : Colors.grey.shade300,
              ),
              alignment: Alignment.center,
              child: Text(
                months[now.month - 1],
                style: TextStyle(
                  fontSize: 20.0,
                  fontWeight: FontWeight.w600,
                  color: index == 1 ? Colors.white : Colors.deepPurple,
                ),
              ),
            ),
          ),
